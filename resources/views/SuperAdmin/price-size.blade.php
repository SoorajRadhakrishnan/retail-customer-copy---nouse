            ...
            <div class="az-content-body">
                <div class="col-12">
                    <div class="az-dashboard-one-title">
                        <div>
                            <h2 class="az-dashboard-title">Price Size</h2>
                    ...
                    <div class="az-dashboard-nav border-0">
                        <nav class="nav">
                            <button id="createbtn" class="nav-linkk btn btn-dark rounded-10 shadoww mr-2 mb-2 dynamicPopup"
                                data-pop="md" data-url="{{ url('price-size/create') }}"
                                    ...
                                    <table id="example" class="table table-hover table-custom border-bottom-0" style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Branch</th>
                                                <th>Price Size Name</th>
                                                <th>Action</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @if (count($price_sizes) > 0)
                                                @foreach ($price_sizes as $key => $price_size)
                                                    <tr>
                                                        <td style="width: 15%">{{ $key + 1 }}</td>
                                                        <td>{{ Str::ucfirst($price_size->branch->branch_name) }}</td>
                                                        <td>{{  Str::ucfirst($price_size->size_name) }}</td>
                                                        <td>
                                                            <div class="dropstart">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-menu-right rounded-10 border"
                                                                   ...
                                                                   <li>
                                                                        <a class="dropdown-item rounded-0 border-bottom dynamicPopup"
                                                                            data-pop="md"
                                                                            data-url="{{ url('price-size/')."/".$price_size->uuid."/edit" }}"
                                                                            data-toggle="modal"
                                                                    ...
                                                                    <li>
                                                                        <a class="dropdown-item rounded-0 border-0"
                                                                            ...
                                                                            onclick="deletemodel('{{ $price_size->uuid }}','{{ $price_size->size_name }}','Delete Price Size','{{ url('price-size').'/'.$price_size->uuid }}')">Delete</a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </td>
