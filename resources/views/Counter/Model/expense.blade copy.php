            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-group mt-0 mb-0">
                        ...
                        <input type="text" class="form-control rounded-10" id="invoice_no" placeholder="" name="invoice_no" autofocus="" value="{{ optional($expense)->invoice_no }}">
                        <div class="valid-feedback">&nbsp;</div>
                        <div class="invalid-feedback">&nbsp;</div>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group mt-0 mb-0">
                        ...
                        <input type="text" class="form-control rounded-10" id="description" placeholder="" name="description" autofocus="" value="{{ optional($expense)->description }}">
                        <div class="valid-feedback">&nbsp;</div>
                        <div class="invalid-feedback">&nbsp;</div>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group mt-0 mb-0">
                        ...
                        <input type="number" class="form-control rounded-10" id="tot_bf_vat" placeholder="" name="tot_bf_vat" autofocus="" value="{{ optional($expense)->tot_bf_vat }}" required="">
                        <div class="valid-feedback">&nbsp;</div>
                        <div class="invalid-feedback">&nbsp;</div>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group mt-0 mb-0">
                        ...
                        <input type="number" class="form-control rounded-10" id="vat_amt" placeholder="" name="vat_amt" autofocus="" value="{{ optional($expense)->vat_amt }}" required="">
                        <div class="valid-feedback">&nbsp;</div>
                        <div class="invalid-feedback">&nbsp;</div>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group mt-0 mb-0">
                        ...
                        <input type="number" class="form-control rounded-10" id="amount" placeholder="" name="amount" autofocus="" value="{{ optional($expense)->amount }}" required="">
                        <div class="valid-feedback">&nbsp;</div>
                        <div class="invalid-feedback">&nbsp;</div>
                    </div>
                </div>
