                    ...
                    <div class="az-dashboard-nav border-0">
                        <nav class="nav">
                            <button id="createbtn" class="nav-linkk btn btn-dark rounded-10 shadoww mr-2 mb-2 dynamicPopup"
                                data-pop="md" data-url="{{ url('admin/payment-method/create') }}"
                                            ...
                                            @if (count($payment_methods) > 0)
                                                @foreach ($payment_methods as $key => $payment_method)
                                                    <tr>
                                                        ...
                                                        <td>{{  showAmount(getPaymentOpeningBalance($payment_method->payment_method_slug, $payment_method->branch_id)) }}</td>
                                                        <td>
                                                            <div class="dropstart">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-menu-right rounded-10 border"
                                                                   ...
                                                                   <li>
                                                                        <a class="dropdown-item rounded-0 border-bottom dynamicPopup"
                                                                            data-pop="md"
                                                                            data-url="{{ url('admin/payment-method/')."/".$payment_method->uuid."/edit" }}"
                                                                            data-toggle="modal"
                                                                    ...
                                                                    {{-- <li>
                                                                        <a class="dropdown-item rounded-0 border-0"
                                                                            ...
                                                                            onclick="deletemodel('{{ $payment_method->uuid }}','{{ $payment_method->payment_method_name }}','Delete payment method','{{ url('admin/payment-method').'/'.$payment_method->uuid }}')">Delete</a>
                                                                    </li> --}}
                                                                </ul>
                                                            </div>
                                                        </td>
