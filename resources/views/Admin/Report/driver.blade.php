...
$title = 'DRIVER WISE REPORT'.$branch_name.' - '.$from_date." - ".$to_date;
...
$driver_id = (isset($_GET['driver_id']) && $_GET['driver_id'] != '') ? $_GET['driver_id'] : '';
            ...
            <div class="az-content-body">
                <div class="col-12">
                    <div class="az-dashboard-one-title">
                        <div>
                            <h2 class="az-dashboard-title">Driver Wise Report</h2>
                        ...
                        <div class="card-header">
                            <form>
                                <div class="row d-flex flex-wrap">
                                    ...
                                    <div class="w-auto ml-3">
                                        <label class="mb-0 d-block small font-weight-bold">Drivers</label>
                                        <select class="form-control rounded-10 select2" id="driver_id" name="driver_id"
                            ...
                            <div class="card rounded-10 shadow">
                                <div class="card-body overflow-auto">
                                    {{-- <div class="dt-buttons">
                                        <a href="{{ url('admin/driver-wise-excel') }}?from_date={{ $from_date }}&to_date={{ $to_date }}&driver_id={{ $driver_id }}"
                                        ...
                                        <a href="{{ url('admin/driver-wise-print') }}?from_date={{ $from_date }}&to_date={{ $to_date }}&driver_id={{ $driver_id }}" class="dt-button buttons-print btn btn-dark px-3 rounded-10" tabindex="0"
