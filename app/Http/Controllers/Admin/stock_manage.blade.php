                        ...
                        <div class="card-header">
                            <form>
                                <div class="row d-flex flex-wrap">
                                        ...
                                        <select class="form-control rounded-10 select2" id="item_id" name="item_id"
                                            ...
                                            @foreach ($items as $item)
                                                <option value="{{ $item->price_id }}"
                                                    ...
                                                    {{ Str::ucfirst($item->item_name)." - ". $item->size_name}}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="w-auto ml-3">
                                        <label class="mb-0 d-block small">Action Type</label>
                                    ...
                                    <div class="w-auto ml-3">
                                        <label class="mb-0 d-block small">&nbsp;</label>
