...
class CustomerWiseExport implements FromCollection,WithHeadings, WithEvents, WithCustomStartCell, WithMapping
{
    protected $request;
    ...
    */
    ...
    public function map($user): array
    {
        ...
        return [
            Str::ucfirst(getCustomer($user->customer_id)->customer_name) ." - ". getCustomer($user->customer_id)->customer_number,
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                $event->sheet->setCellValue('A1', 'Customer Wise Report');
