...
class ItemWiseExport implements FromCollection,WithHeadings, WithEvents, WithCustomStartCell, WithMapping
{
    protected $request;
    ...
    */
    public function collection()
    {
        ...
        if(auth()->user()->branch_id)
        {
            ...
            })->when($item, function (Builder $query,$item) {
    ...
    public function map($user): array
    {
        ...
        return [
            getItemNameSize($user->price_size_id),
            $user->total_qty,
            showAmount($user->cost_price),
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                $event->sheet->setCellValue('A1', 'Item Wise Report');
